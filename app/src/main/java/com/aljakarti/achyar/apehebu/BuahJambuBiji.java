...
public class BuahJambuBiji extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.jambubiji0, R.drawable.jambubiji1, R.drawable.jambubijiindo, R.drawable.jambubijiinggris, R.drawable.jambubijiarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.jambubiji0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJambuBiji.this, R.raw.jambubiji_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jambubijiindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJambuBiji.this, R.raw.jambubiji_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jambubijiinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJambuBiji.this, R.raw.jambubiji_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jambubijiarab);
            }
        });
