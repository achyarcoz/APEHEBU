...
public class BuahCherry extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.ceri0, R.drawable.ceri1, R.drawable.ceriindo, R.drawable.ceriinggris, R.drawable.ceriarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.ceri0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahCherry.this, R.raw.cherry_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ceriindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahCherry.this, R.raw.cherry_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ceriinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahCherry.this, R.raw.cherry_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ceriarab);
            }
        });
