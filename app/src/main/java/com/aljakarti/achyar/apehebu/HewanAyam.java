...
public class HewanAyam extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.ayam0,R.drawable.ayam1,R.drawable.ayamindo,R.drawable.ayaminggris,R.drawable.ayamarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.ayam0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanAyam.this, R.raw.ayam_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ayamindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanAyam.this, R.raw.ayam_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ayaminggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanAyam.this, R.raw.ayam_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ayamarab);
