...
public class BuahMangga extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.mangga0, R.drawable.mangga1, R.drawable.manggaindo, R.drawable.manggainggris, R.drawable.manggaarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.mangga0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahMangga.this, R.raw.mangga_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.manggaindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahMangga.this, R.raw.mangga_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.manggainggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahMangga.this, R.raw.mangga_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.manggaarab);
            }
        });
