...
public class HewanKuraKura extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.kurakura0,R.drawable.kurakura1,R.drawable.kurakuraindo,
            R.drawable.kurakurainggris,R.drawable.kurakuraarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.kurakura0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKuraKura.this, R.raw.kurakura_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kurakuraindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKuraKura.this, R.raw.kurakura_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kurakurainggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKuraKura.this, R.raw.kurakura_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kurakuraarab);
            }
        });
