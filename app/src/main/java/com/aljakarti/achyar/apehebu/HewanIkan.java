...
public class HewanIkan extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.ikan0,R.drawable.ikan1,R.drawable.ikanindo,
            R.drawable.ikaninggris,R.drawable.ikanarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.ikan0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanIkan.this, R.raw.ikan_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ikanindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanIkan.this, R.raw.ikan_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ikaninggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanIkan.this, R.raw.ikan_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ikanarab);
            }
        });
