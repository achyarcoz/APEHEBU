...
public class BuahDurian extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.durian0, R.drawable.durian1, R.drawable.durianindo, R.drawable.durianinggris, R.drawable.durianarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.durian0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahDurian.this, R.raw.durian_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.durianindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahDurian.this, R.raw.durian_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.durianinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahDurian.this, R.raw.durian_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.durianarab);
            }
        });
