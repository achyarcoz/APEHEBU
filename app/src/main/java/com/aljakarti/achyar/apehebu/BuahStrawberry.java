...
public class BuahStrawberry extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.stroberi0, R.drawable.stroberi1, R.drawable.stroberiindo, R.drawable.semangkainggris, R.drawable.stroberiarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.stroberi0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahStrawberry.this, R.raw.strawberry_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.stroberiindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahStrawberry.this, R.raw.strawberry_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.stroberiinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahStrawberry.this, R.raw.strawberry_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.stroberiarab);
            }
        });
