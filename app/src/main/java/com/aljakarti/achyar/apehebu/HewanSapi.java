...
public class HewanSapi extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.sapi0,R.drawable.sapi1,R.drawable.sapiindo,R.drawable.sapiinggris,R.drawable.sapiarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.sapi0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanSapi.this, R.raw.sapi_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.sapiindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanSapi.this, R.raw.sapi_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.sapiinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanSapi.this, R.raw.sapi_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.sapiarab);
            }
        });
