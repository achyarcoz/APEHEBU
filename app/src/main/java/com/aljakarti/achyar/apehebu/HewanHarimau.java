...
public class HewanHarimau extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.harimau0,R.drawable.harimau1,R.drawable.harimauindo,
            R.drawable.harimauinggris,R.drawable.harimauarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.harimau0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanHarimau.this, R.raw.harimau_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.harimauindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanHarimau.this, R.raw.harimau_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.harimauinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanHarimau.this, R.raw.harimau_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.harimauarab);
            }
        });
