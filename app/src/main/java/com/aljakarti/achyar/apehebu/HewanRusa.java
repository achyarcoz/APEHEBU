...
public class HewanRusa extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.rusa0,R.drawable.rusa1,R.drawable.rusaindo,R.drawable.rusainggris,R.drawable.rusaarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.rusa0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanRusa.this, R.raw.rusa_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.rusaindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanRusa.this, R.raw.rusa_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.rusainggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanRusa.this, R.raw.rusa_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.rusaarab);
            }
        });
