...
public class BuahPisang extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.pisang0, R.drawable.pisang1, R.drawable.pisangindo, R.drawable.pisanginggris, R.drawable.pisangarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.pisang0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahPisang.this, R.raw.pisang_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.pisangindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahPisang.this, R.raw.pisang_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.pisanginggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahPisang.this, R.raw.pisang_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.pisangarab);
            }
        });
