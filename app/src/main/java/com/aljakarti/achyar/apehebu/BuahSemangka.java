...
public class BuahSemangka extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.semangka0, R.drawable.semangka1, R.drawable.semangkaindo, R.drawable.semangkainggris, R.drawable.semangkaarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.semangka0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahSemangka.this, R.raw.semangka_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.semangkaindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahSemangka.this, R.raw.semangka_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.semangkainggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahSemangka.this, R.raw.semangka_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.semangkaarab);
            }
        });
