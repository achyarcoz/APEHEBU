...
public class HewanKambing extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.kambing0,R.drawable.kambing1,R.drawable.kambingindo,
            R.drawable.kambinginggris,R.drawable.kambingarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.kambing0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKambing.this, R.raw.kambing_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kambingindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKambing.this, R.raw.kambing_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kambinginggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKambing.this, R.raw.kambing_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kambingarab);
            }
        });
