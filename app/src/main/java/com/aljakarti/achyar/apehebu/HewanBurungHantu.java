...
public class HewanBurungHantu extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.burunghantu0,R.drawable.burunghantu1,R.drawable.burunghantuindo,
            R.drawable.burunghantuinggris,R.drawable.burunghantuarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.burunghantu0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBurungHantu.this, R.raw.burunghantu_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.burunghantuindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBurungHantu.this, R.raw.burunghantu_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.burunghantuinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBurungHantu.this, R.raw.burunghantu_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.burunghantuarab);
            }
        });
