...
public class HewanKera extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.kera0,R.drawable.kera1,R.drawable.keraindo,R.drawable.kerainggris,R.drawable.keraarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.kera0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKera.this, R.raw.kera_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.keraindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKera.this, R.raw.kera_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.kerainggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanKera.this, R.raw.kera_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.keraarab);
            }
        });
