...
public class BuahManggis extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.manggis0, R.drawable.manggis1, R.drawable.manggisindo, R.drawable.manggisinggris, R.drawable.manggisarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.manggis0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahManggis.this, R.raw.manggis_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.manggisindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahManggis.this, R.raw.manggis_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.manggisinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahManggis.this, R.raw.manggis_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.manggisarab);
            }
        });
