...
public class HewanBeruang extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.beruang0,R.drawable.beruang1,R.drawable.beruangindo,R.drawable.beruanginggris,R.drawable.beruangarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.beruang0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBeruang.this, R.raw.beruang_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.beruangindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBeruang.this, R.raw.beruang_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.beruanginggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBeruang.this, R.raw.beruang_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.beruangarab);
            }
        });
