...
public class HewanUlar extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.ular0,R.drawable.ular1,R.drawable.ularindo,R.drawable.ularinggris,R.drawable.ulararab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.ular0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanUlar.this, R.raw.ular_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ularindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanUlar.this, R.raw.ular_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ularinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanUlar.this, R.raw.ular_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.ulararab);
            }
        });
