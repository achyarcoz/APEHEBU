...
public class BuahAnggur extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.anggur0, R.drawable.anggur1, R.drawable.anggurindo,
            R.drawable.angguringgris, R.drawable.anggurarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.anggur0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahAnggur.this, R.raw.anggur_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.anggurindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahAnggur.this, R.raw.anggur_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.angguringgris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahAnggur.this, R.raw.anggur_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.anggurarab);
            }
        });
