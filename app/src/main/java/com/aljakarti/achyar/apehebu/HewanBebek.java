...
public class HewanBebek extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.bebek0,R.drawable.bebek1,R.drawable.bebekindo,
            R.drawable.bebekinggris,R.drawable.bebekarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.bebek0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBebek.this, R.raw.bebek_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.bebekindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBebek.this, R.raw.bebek_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.bebekinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HewanBebek.this, R.raw.bebek_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.bebekarab);
            }
        });
