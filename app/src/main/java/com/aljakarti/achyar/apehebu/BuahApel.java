...
public class BuahApel extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.apel0, R.drawable.apel1, R.drawable.apelindo, R.drawable.apelinggris, R.drawable.apelarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.apel0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahApel.this, R.raw.apel_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.apelindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahApel.this, R.raw.apel_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.apelinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahApel.this, R.raw.apel_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.apelarab);
            }
        });
