...
public class BuahJeruk extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.jeruk0, R.drawable.jeruk1, R.drawable.jerukindo, R.drawable.jerukinggris, R.drawable.jerukarab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.jeruk0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJeruk.this, R.raw.jeruk_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jerukindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJeruk.this, R.raw.jeruk_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jerukinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJeruk.this, R.raw.jeruk_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jerukarab);
            }
        });
