...
public class BuahAlpukat extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.alpukat0, R.drawable.alpukat1, R.drawable.alpukatindo,
            R.drawable.alpukatinggris, R.drawable.alpukatarab,};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.alpukat1);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahAlpukat.this, R.raw.alpukat_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.alpukatindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahAlpukat.this, R.raw.alpukat_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.alpukatinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahAlpukat.this, R.raw.alpukat_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.alpukatarab);
            }
        });
