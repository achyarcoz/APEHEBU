...
public class BuahJambuMete extends AppCompatActivity {
    ...
    Integer[] images = {R.drawable.jambumete0, R.drawable.jambumete1, R.drawable.jambumeteindo, R.drawable.jambumeteinggris, R.drawable.jambumetearab};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setImageResource(R.drawable.jambumete0);
        ...
        indo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJambuMete.this, R.raw.jambumete_indo);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jambumeteindo);
            }
        });
        ...
        inggris.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJambuMete.this, R.raw.jambumete_inggris);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jambumeteinggris);
            }
        });
        ...
        arab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(BuahJambuMete.this, R.raw.jambumete_arab);
                mp.start();
                imageSwitcher.setImageResource(R.drawable.jambumetearab);
            }
        });
